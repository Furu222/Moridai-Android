...
public class FragmentAnswer extends Fragment {
	...
	@Override
	 public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		...
		View v = inflater.inflate(R.layout.grade_list, container, false);
		...
		// アダプター
		adapter = new MyExpandListAdapter(getActivity(), groupList, childList);
		...
		lv.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				Intent intent = new Intent(getActivity(), AnswerCategoryListActivity.class);
